...
if(isset($_POST['submit'])){
	...
	$sql="update azura_user set eventposter='$filename' where role='organizer' and email='".$email."'";
...
<html>
	<head>
		<title>Organizer upload Poster</title>
		<meta charset="utf-8" />
					...
					<div class="inner">
						...
						?>
							...
							<div class="flex flex-tabs">
								...
								<table><tr><td>
										<td><label><h3>Event Poster</h3></label></td>
										<td>
										<div class="6u$ 12u$(xsmall)">
											<input type="file" name="file" required="required" id="file" value="" placeholder="Event Poster" />
										</div>
										</td>
										</tr>
										</table>
