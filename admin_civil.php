	   ...
	   <section class="wrapper style2">
					<div class="inner">
						...
						<!-- Tabbed Video Section -->
							<div class="flex flex-tabs">
								<ul class="tab-list">
									<li><a href="admin_cse.php" data-tab="tab-1">CSE</a></li>
									<li><a href="admin_ece.php" data-tab="tab-2">ECE</a></li>
									<li><a href="admin_eee.php" data-tab="tab-3">EEE</a></li>
									<li><a href="admin_civil.php" data-tab="tab-4">CIVIL</a></li>
									<li><a href="admin_mech.php" data-tab="tab-5">MECHANICAL</a></li>
									<li><a href="admin_mba.php" data-tab="tab-6">MBA</a></li>
									</ul>
									<div class="tabs">
									<div class="tab tab-1 flex flex-3 active">
									<?php
									$connector = mysqli_connect("localhost","root","","azura") or die("Unable to connect");
										$result = mysqli_query($connector,"SELECT name,eventname,phoneno from azura_user where role='organizer' and branch='civil' and eventtype='technical'");
									?>
