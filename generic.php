				...
				<section class="wrapper style1">
					<div class="inner">
						...
						#echo $row2;
							    ...
							    $sql="select eventname,eventposter,eventabstract,eventposter from azura_user where role='organizer' and eventname='".$row3."'";
						...
						<?php
echo file_get_contents("AbstractUploads/".$row['eventabstract']."");
}
								?>
